...
[account_invoice_import_simple_pdf](account_invoice_import_simple_pdf/) | 14.0.2.2.1 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Import simple PDF vendor bills
...
[edi_oca](edi_oca/) | 14.0.1.14.1 | [![simahawk](https://github.com/simahawk.png?size=30px)](https://github.com/simahawk) [![etobella](https://github.com/etobella.png?size=30px)](https://github.com/etobella) | Define backends, exchange types, exchange records, basic automation and views for handling EDI exchanges.
...
[edi_storage_oca](edi_storage_oca/) | 14.0.1.7.0 |  | Base module to allow exchanging files via storage backend (eg: SFTP).
...
[edi_webservice_oca](edi_webservice_oca/) | 14.0.1.3.0 | [![etobella](https://github.com/etobella.png?size=30px)](https://github.com/etobella) [![simahawk](https://github.com/simahawk.png?size=30px)](https://github.com/simahawk) | Defines webservice integration from EDI Exchange records
...
[sale_order_import_ubl](sale_order_import_ubl/) | 14.0.1.3.0 |  | Import UBL XML sale order files
