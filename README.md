...
[account_invoice_import_simple_pdf](account_invoice_import_simple_pdf/) | 14.0.2.0.1 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Import simple PDF vendor bills
...
[base_business_document_import](base_business_document_import/) | 14.0.2.3.0 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Provides technical tools to import sale orders or supplier invoices
...
[edi_oca](edi_oca/) | 14.0.1.8.4 | [![simahawk](https://github.com/simahawk.png?size=30px)](https://github.com/simahawk) [![etobella](https://github.com/etobella.png?size=30px)](https://github.com/etobella) | Define backends, exchange types, exchange records, basic automation and views for handling EDI exchanges.
...
[edi_storage_oca](edi_storage_oca/) | 14.0.1.5.1 |  | Base module to allow exchanging files via storage backend (eg: SFTP).
...
[pdf_helper](pdf_helper/) | 14.0.1.0.0 | [![simahawk](https://github.com/simahawk.png?size=30px)](https://github.com/simahawk) [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Provides helpers to work w/ PDFs
...
[sale_order_import](sale_order_import/) | 14.0.1.3.0 |  | Import RFQ or sale orders from files
