...
class AccountInvoice(models.Model):
    ...
    transfer_ids = fields.One2many('base.edi.transfer', 'ai_id', string="Transfers")
    ...
    def send_via_edi_exchange(self):
        ...
        result, mime = self.env.ref('account.account_invoices').render_qweb_pdf([self.id])
        try:
