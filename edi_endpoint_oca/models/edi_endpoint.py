...
class EDIEndpoint(models.Model):
    ...
    _endpoint_base_controller_class = EDIEndpointController
    ...
    def create_exchange_record(self, **vals):
        """Create an EDI exchange record from current endpoint.

        Just a shortcut.
        """
        self._check_endpoint_ready()
        return self.backend_id.create_record(self.exchange_type_id.code, vals)
