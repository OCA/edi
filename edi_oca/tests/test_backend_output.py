...
class EDIBackendTestCase(EDIBackendCommonComponentRegistryTestCase):
    ...
    def setUp(self):
        ...
        FakeOutputSender._build_component(self.comp_registry)
        FakeOutputGenerator._build_component(self.comp_registry)
        FakeOutputChecker._build_component(self.comp_registry)
