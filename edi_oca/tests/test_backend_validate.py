...
class EDIBackendTestCase(EDIBackendCommonComponentRegistryTestCase):
    ...
    def test_receive_validate_record(self):
        ...
        self.assertEqual(self.record_in.edi_exchange_state, "input_received")
    ...
    def test_receive_validate_record_error(self):
        ...
        self.assertTrue(FakeInputValidate.check_called_for(self.record_in))
        self.assertEqual(self.record_in.edi_exchange_state, "validate_error")
        self.assertEqual(self.record_in.exchange_error, repr(exc))
    ...
    def test_generate_validate_record(self):
        ...
        self.assertEqual(self.record_out.edi_exchange_state, "output_pending")
    ...
    def test_generate_validate_record_error(self):
        ...
        self.assertTrue(FakeOutputValidate.check_called_for(self.record_out))
        self.assertEqual(self.record_out.edi_exchange_state, "validate_error")
        self.assertEqual(self.record_out.exchange_error, repr(exc))
