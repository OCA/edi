...
class EDIBackendTestCase(AccountTestInvoicingCommon, SavepointComponentRegistryCase):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        class SaleOrderEventListenerDemo(Component):
            _name = "sale.order.event.listener.demo"
            _inherit = "base.event.listener"

            def on_post_sale_order(self, move):
                move.name = "new_name"

            def on_paid_sale_order(self, move):
                move.name = "paid"

            def on_cancel_sale_order(self, move):
                move.name = "cancelled"

        SaleOrderEventListenerDemo._build_component(cls.comp_registry)
